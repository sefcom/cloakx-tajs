...
public final class ObjectLabel implements Comparable<ObjectLabel>, DeepImmutable {
    ...
    /**
     * Adds unique option for object label for hostobject of the specified kind constructor
     * @param hostobject
     * @param kind
     * @return
     */
    public static ObjectLabel make(HostObject hostobject, Kind kind, AbstractNode n) {
        return make(hostobject, n, null, kind, null, true);
    }
