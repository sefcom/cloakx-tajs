...
/**
 * The complex part of soundness testing: checks that addFiles entries from a concete execution are over-approximated by the abstract states computed by the static analysis.
 *
