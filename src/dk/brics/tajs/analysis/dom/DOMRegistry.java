...
public class DOMRegistry {
    ...
    private static ObjectLabel sendMessageEvent;
    ...
    public static void registerSendMessageLabel(ObjectLabel l) {
        sendMessageEvent = l;
    }
    ...
    public static ObjectLabel getSendMessageEventLabel() {
        if (sendMessageEvent == null) {
            throw new AnalysisException("No send message event labels registered");
        }
