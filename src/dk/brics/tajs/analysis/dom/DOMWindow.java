                    ...
                    if (!callbackSourceCode.isNone()) {
                        if (callbackSourceCode.isMaybeSingleStr()) {
                            ...
                            if (call.getSourceNode() instanceof CallNode) {
                                ...
                                // erikt, setTimeout throws error if uneval cannot evaluate function passed in, since
                                // the function will be called another way, catch and continue
                                try {
                                ...
                                } catch (AnalysisLimitationException.AnalysisPrecisionLimitationException aple){
                                    System.out.println("HIT ANALYSIS Limitation with setTimout!!!!");
