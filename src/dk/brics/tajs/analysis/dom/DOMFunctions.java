...
public class DOMFunctions {
     ...
     */
    public static ObjectLabel getHTMLObjectLabel(String tagname, Solver.SolverInterface c) {
        switch (tagname.toLowerCase()) {
            ...
            case "div":
                return HTMLDivElement.getUniqueInstance(c);
    ...
    public static Value evaluate(DOMObjects nativeObject, CallInfo call, Solver.SolverInterface c) {
        switch (nativeObject) {
            ...
            /*case CHROME_RUNTIME_SEND_MESSAGE:
            case CHROME_RUNTIME_GETURL:
            case CHROME_RUNTIME_ONMESSAGE_ADDLISTENER:
            case CHROME_DUMMY:
            ...
            case ELEMENT_CREATE_SHADOWROOT:
    ...
    static void registerElementIdentifiersForSetter(ObjectLabel label, String name, Value value, State state) {
        ...
        if ("id".equalsIgnoreCase(name)) {
            ...
            state.getExtras().addValueToMayMap(DOMRegistry.MayMaps.ELEMENTS_BY_ID.name(), value.getStr(), value);
        }
