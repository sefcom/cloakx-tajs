        ...
        switch (nativeobject) {
            ...
            case DOCUMENT_GET_ELEMENT_BY_ID: {
                ...
                if (id.isMaybeSingleStr()) {
                    ...
                    if (labels.isEmpty()) {
                        //FIXME: I probably should add an option for this -Erik
                        // create a placeholder object when it cannot find the object, should this be added to the map?
                        Value fakeDOMObj = Value.makeObject(DOMFunctions.getHTMLObjectLabel("div", c));
