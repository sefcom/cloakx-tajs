...
import dk.brics.tajs.analysis.dom.chrome.CEXFunctions;
...
public enum HostAPIs implements HostAPI {
    ...
    CHROME_EXTENSION_APIS("Chrome Extension APIs", "cex");
    ...
    public static Value evaluate(HostObject hostobject, CallInfo call, Solver.SolverInterface c) {
        ...
        switch ((HostAPIs) hostobject.getAPI()) {
            ...
            case CHROME_EXTENSION_APIS:
                return CEXFunctions.evaluate((DynamicDOMObject) hostobject, call, c);
            case TAJS:
