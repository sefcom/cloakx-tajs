...
import static dk.brics.tajs.analysis.nativeobjects.ECMAScriptObjects.FUNCTION_BIND;
...
public class NativeFunctionSignatureBuilder {
    ...
    private void initializeSignatures() {
        ...
        addSig(STRING_REPLACE, Receivers.NotNullUndefCoerceString, OptionalParameters.StringIfNotRegExp, OptionalParameters.StringIfNotRegExp);
        ...
        addVarSig(FUNCTION_BIND, Receivers.Function, OptionalParameters.DontCare, OptionalParameters.DontCare);
