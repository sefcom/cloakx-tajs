...
public class FunctionCalls {
    ...
    public static class AbstractCallInfo implements CallInfo {
        ...
        public AbstractCallInfo(AbstractNode sourceNode,  Value function, List<Value> args, State state) {
        ...
        @Override
        public Value getThis() {
            throw new AnalysisException("this is not available for abstract calls");
        }
    ...
    /**
     * Reads base Value of function call
     */
    public static Value readBaseValue(CallInfo call, State state) {
        CallNode cn = (CallNode) call.getSourceNode();

        return UnknownValueResolver.getRealValue(state.readRegister(cn.getBaseRegister()), state);
