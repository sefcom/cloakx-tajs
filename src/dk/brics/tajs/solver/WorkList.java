...
//                addFiles.debug("Removing entry " + e);
//    }
    ...
    public class Entry implements IWorkListStrategy.IEntry<ContextType>, Comparable<Entry> {
        ...
        @Override
        public String toString() {
            // if pending_set has more than 1 then put on own line
            return b.toShortString(pending_set.size());
            //Integer.toString(b.getIndex());
        }
    }
}
